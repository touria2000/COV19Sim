...
# Put data into list
data = list(n_days = n_days, n_difeq=8, pop=pop, t0 = t0, ts = t, cases = cases)

## Compile the model 
m <- stan_model("C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/models/model_v2.stan")
...
# Save the model
save(fit_model, file='C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/saved_models/fit2')
# Load the model
load('C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/saved_models/fit2')
...
ggsave("C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/plots/fit_chain.pdf", 
...
write.table(df_theta, 
            file = "C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/theta_values.csv", 
            sep = ",", row.names = FALSE)

# Initial conditions
Mat_IC <- posts_fit$y_init
write.table(Mat_IC, 
            file = "C:/Users/Touria/Documents/NovelCovid19_VaccinationModel/fit_without_vaccination/IC_no.csv", 
            sep = ",", 
