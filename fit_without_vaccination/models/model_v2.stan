...
parameters {
  ...
  real <lower = 1, upper = 5000> E0;  
  real <lower = 1, upper = 5000> IA0;
  real <lower = 1, upper = 5000> IS0;  
  real <lower = 1, upper = 5000> IQ0;
  real <lower = 1, upper = 5000> IH0;    
  real <lower = 1, upper = 5000> R0;
  real <lower = 1, upper = 5000> D0;
}
...
transformed parameters{
  ...
  y_init[1] = pop - (E0 + IA0 + IS0 + IQ0 + IH0 + R0 + D0);
  y_init[2] = E0;
  y_init[3] = IA0;
  y_init[4] = IS0;
  y_init[5] = IQ0;
